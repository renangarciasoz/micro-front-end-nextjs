...
function getOrCreateStore(initialState) {
  ...
  if (isServer) {
    return redux_store_lib__WEBPACK_IMPORTED_MODULE_3___default()(initialState);
  } // Create store if unavailable on the client and set it on the window object


  if (!window[__NEXT_REDUX_STORE__]) {
    window[__NEXT_REDUX_STORE__] = redux_store_lib__WEBPACK_IMPORTED_MODULE_3___default()(initialState);
  }
